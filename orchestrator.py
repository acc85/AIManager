...
class TaskQueueHandler(FileSystemEventHandler):
    def __init__(self, workspace_dir, on_new_task_callback, lock):
...
class Orchestrator:
    def __init__(self, workspace_dir, on_new_task_callback):
        ...
        self.handler = TaskQueueHandler(workspace_dir, on_new_task_callback, self.lock)
    ...
    def rollback_active_task(self):
        with self.lock:
            try:
                ...
                print(f"Error rolling back active task: {e}")
